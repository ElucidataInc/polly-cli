...
module.exports.fetchAppLicense = function(token_filename) {
    ...
    var options = {
        method: 'GET',
        url: 'https://api.polly.elucidata.io/me',
        headers:
            {
                'cache-control': 'no-cache',
...
module.exports.createWorkflowRequest = function (token_filename, 
    ...
    var options = {
        method: 'PUT',
        url: 'https://api.polly.elucidata.io/wf-request',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.createRunRequest = function (token_filename, component_id, project_id,extra_Info) {
    ...
    var options = {
        method: 'PUT',
        url: 'https://api.polly.elucidata.io/run',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.getComponentId = function (token_filename) {
    ...
    var options = {
        method: 'GET',
        url: 'https://api.polly.elucidata.io/component',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.getWorkflowId = function (token_filename) {
    ...
    var options = {
        method: 'GET',
        url: 'https://api.polly.elucidata.io/wf-fe-info',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.getEndpointForRuns = function (token_filename) {
    ...
    var options = {
        method: 'GET',
        url: 'https://api.polly.elucidata.io/ui-endpoints',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.createProject = function (token_filename,name) {
    ...
    var options = {
        method: 'POST',
        url: 'https://api.polly.elucidata.io/project',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.shareProject = function (token_filename,project_id,permission,usernames) {
    ...
    var options = {
        method: 'POST',
        url: 'https://api.polly.elucidata.io/sharing/share_project',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.fetchModels = function (cookie_file) {
    var urlWithFile = 'https://v2.api.polly.elucidata.io/peakml-models';
    var options = {
        method: 'GET',
        url: urlWithFile,
        headers:
...
module.exports.downloadPeakMLModel = function (model_id, cookie_file) {
    var urlWithFile = 'https://v2.api.polly.elucidata.io/peakml-models/' + model_id;
    var options = {
        method: 'GET',
        url: urlWithFile,
        headers:
...
module.exports.downloadPeakMLBinary = function (type, os, cookie_file) {
    var urlWithFile = 'https://v2.api.polly.elucidata.io/peakml-static?type=' + type + '&os=' + os;
