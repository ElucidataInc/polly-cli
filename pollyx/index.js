...
function refreshToken(token_filename,email){
    ...
    var options = {
        method: 'GET',
        url: 'https://api.pollyx.elucidata.io/userpool',
        json: true,
        headers:
        {
...
module.exports.fetchAppLicense = function(token_filename) {
    ...
    var options = {
        method: 'GET',
        url: 'https://api.pollyx.elucidata.io/me',
        headers:
            {
                'cache-control': 'no-cache',
...
module.exports.createWorkflowRequest = function (token_filename, 
    ...
    var options = {
        method: 'PUT',
        url: 'https://api.pollyx.elucidata.io/wf-request',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.createRunRequest = function (token_filename, component_id, project_id,extra_Info) {
    ...
    var options = {
        method: 'PUT',
        url: 'https://api.pollyx.elucidata.io/run',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.getComponentId = function (token_filename) {
    ...
    var options = {
        method: 'GET',
        url: 'https://api.pollyx.elucidata.io/component',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.getWorkflowId = function (token_filename) {
    ...
    var options = {
        method: 'GET',
        url: 'https://api.pollyx.elucidata.io/wf-fe-info',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.getEndpointForRuns = function (token_filename) {
    ...
    var options = {
        method: 'GET',
        url: 'https://api.pollyx.elucidata.io/ui-endpoints',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.createProject = function (token_filename,name) {
    ...
    var options = {
        method: 'POST',
        url: 'https://api.pollyx.elucidata.io/project',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.shareProject = function (token_filename,project_id,permission,usernames) {
    ...
    var options = {
        method: 'POST',
        url: 'https://api.pollyx.elucidata.io/sharing/share_project',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
