...
module.exports.fetchAppLicense = function(token_filename) {
    ...
    var options = {
        method: 'GET',
        url: 'https://api.devpolly.elucidata.io/me',
        headers:
            {
                'cache-control': 'no-cache',
...
module.exports.createWorkflowRequest = function (token_filename, 
    ...
    var options = {
        method: 'PUT',
        url: 'https://api.devpolly.elucidata.io/wf-request',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.getComponentId = function (token_filename) {
    ...
    var options = {
        method: 'GET',
        url: 'https://api.devpolly.elucidata.io/component',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.getWorkflowId = function (token_filename) {
    ...
    var options = {
        method: 'GET',
        url: 'https://api.devpolly.elucidata.io/wf-fe-info',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.getEndpointForRuns = function (token_filename) {
    ...
    var options = {
        method: 'GET',
        url: 'https://api.devpolly.elucidata.io/ui-endpoints',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.createProject = function (token_filename,name) {
    ...
    var options = {
        method: 'POST',
        url: 'https://api.devpolly.elucidata.io/project',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.shareProject = function (token_filename,project_id,permission,usernames) {
    ...
    var options = {
        method: 'POST',
        url: 'https://api.devpolly.elucidata.io/sharing/share_project',
        headers:
            {
                'cache-control': 'no-cache',
                'content-type': 'application/json',
...
module.exports.downloadFilesForPeakML = function (filename, cookie_file) {
    var urlWithFile = 'https://v2.api.devpolly.elucidata.io/elmav-binary-files?file_name=' + filename;
    var options = {
        method: 'GET',
        url: urlWithFile,
        headers:
...
module.exports.listBucketObjects = function (cookie_file) {
    var urlWithFile = 'https://v2.api.devpolly.elucidata.io/elmav-binary-files/user-model-files';
    var options = {
        method: 'GET',
        url: urlWithFile,
        headers:
...
module.exports.fetchModels = function (cookie_file) {
    var urlWithFile = 'https://v2.api.devpolly.elucidata.io/peakml-models';
    var options = {
        method: 'GET',
        url: urlWithFile,
        headers:
